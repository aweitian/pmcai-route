...
class Router
{
     ...
     *
     * @var \Tian\Route\RouteCollection
     */
    protected $routes;
     ...
     * @param  \Tian\Container $container
     */
    ...
    protected function addRoute($methods, $uri, $action)
    {
        ...
        return $this->routes->add($name,$this->createRoute($methods, $uri, $action));
    }
...
//            ->setContainer($this->container);
     ...
     *
     * @param  \Tian\Http\Request  $request
     ...
     *
     * @return \Tian\Route\RouteCollection
     */
     ...
     *
     * @param  \Tian\Route\RouteCollection  $routes
     * @return void
     */
