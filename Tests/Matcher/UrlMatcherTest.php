...
namespace Tian\Routing\Tests\Matcher;

use Tian\Routing\Exception\MethodNotAllowedException;
use Tian\Routing\Exception\ResourceNotFoundException;
use Tian\Routing\Matcher\UrlMatcher;
...
class UrlMatcherTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMatchOverriddenRoute()
    {
        ...
        $this->setExpectedException('Tian\Routing\Exception\ResourceNotFoundException');
    ...
    /**
     * @expectedException \Tian\Routing\Exception\ResourceNotFoundException
     */
