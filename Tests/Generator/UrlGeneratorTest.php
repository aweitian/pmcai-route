...
namespace Tian\Routing\Tests\Generator;

use PHPUnit\Framework\TestCase;
use Tian\Routing\RouteCollection;
use Tian\Routing\Route;
use Tian\Routing\Generator\UrlGenerator;
use Tian\Routing\Generator\UrlGeneratorInterface;
...
class UrlGeneratorTest extends TestCase
{
    ...
    /**
     * @expectedException \Tian\Routing\Exception\InvalidParameterException
     */
    ...
    /**
     * @expectedException \Tian\Routing\Exception\RouteNotFoundException
     */
    ...
    /**
     * @expectedException \Tian\Routing\Exception\MissingMandatoryParametersException
     */
    ...
    public function testAdjacentVariables()
    {
        ...
        $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}('Tian\Routing\Exception\InvalidParameterException');
